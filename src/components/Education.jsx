        ...
        >
          {education.map((edu, index) => (
            <motion.div
              ...
              className="relative pl-8 md:pl-0 md:grid md:grid-cols-12 gap-6 items-stretch"
            >
              ...
              {/* Content */}
              <div className="md:col-span-5 p-6 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
